 ...
 */
final class Version20230208055907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "Movies" (id INT NOT NULL, owner_id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, photo_path VARCHAR(255) DEFAULT NULL, date_published TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, slug VARCHAR(255) NOT NULL, likes INT DEFAULT NULL, hates INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "Votes" (id INT NOT NULL, movie_id INT NOT NULL, voter_id INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_liked BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_904A55CB8F93B6FC ON "Votes" (movie_id)');
        $this->addSql('CREATE INDEX IDX_904A55CBEBB4B8AD ON "Votes" (voter_id)');
        ...
        $this->addSql('ALTER TABLE "Votes" ADD CONSTRAINT FK_904A55CBEBB4B8AD FOREIGN KEY (voter_id) REFERENCES "Users" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "Votes" DROP CONSTRAINT FK_904A55CBEBB4B8AD');
